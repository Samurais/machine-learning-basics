...
def loadMNISTLabels(file_name):
    ...
    label_file = gzip.open(file_name, 'rb')
...
def executeSoftmaxRegression():
    ...
    training_data   = loadMNISTImages('data/train-images-idx3-ubyte.gz')
    training_labels = loadMNISTLabels('data/train-labels-idx1-ubyte.gz')
    ...
    test_data   = loadMNISTImages('data/t10k-images-idx3-ubyte.gz') 
    test_labels = loadMNISTLabels('data/t10k-labels-idx1-ubyte.gz')
